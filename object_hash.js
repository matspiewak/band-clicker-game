        ...
        function (w, b, m) {
          (function (e, t, f, n, r, o, i, u, a) {
            ...
            ((m = b.exports = l).sha1 = function (e) {
              ...
              (m.MD5 = function (e) {
                return l(e, { algorithm: "md5", encoding: "hex" });
              }),
            ...
            var c = s.getHashes ? s.getHashes().slice() : ["sha1", "md5"];
            c.push("passthrough");
            ...
            function h(e, t) {
              ...
              for (var r = 0; r < c.length; ++r)
                c[r].toLowerCase() === n.algorithm.toLowerCase() &&
                  (n.algorithm = c[r]);
              if (-1 === c.indexOf(n.algorithm))
                throw new Error(
                  'Algorithm "' +
                    n.algorithm +
              ...
              if (-1 === d.indexOf(n.encoding) && "passthrough" !== n.algorithm)
                throw new Error(
                  'Encoding "' +
                    n.encoding +
                    '"  not supported. supported values: ' +
            ...
            function g(u, t, a) {
              ...
              return {
                ...
                _object: function (t) {
                  ...
                  if ((a.push(t), void 0 !== f && f.isBuffer && f.isBuffer(t)))
                    return s("buffer:"), s(t);
                  if (
                    "object" === n ||
                    "function" === n ||
                    ...
                    return o.forEach(function (e) {
                      i.dispatch(e),
                        s(":"),
                        u.excludeValues || i.dispatch(t[e]),
                        s(",");
                    });
                  }
                  if (!this["_" + n]) {
                ...
                _array: function (e, t) {
                  ...
                  var n = this;
                  if ((s("array:" + e.length + ":"), !t || e.length <= 1))
                ...
                _function: function (e) {
                  s("fn:"),
                    ...
                    !1 !== u.respectFunctionNames &&
                      this.dispatch("function-name:" + String(e.name)),
                    u.respectFunctionProperties && this._object(e);
                },
                _number: function (e) {
                ...
                return (
                  2 == o
                    ? s(
                        255 &
                          (n =
                            (l(e.charAt(t)) << 2) | (l(e.charAt(t + 1)) >> 4))
                      )
                    : 1 == o &&
                      (s(
                        ((n =
          ...
          (function (e, t, g, n, r, o, i, u, a) {
            ...
            function g(e, t, n) {
              ...
              if ("base64" === t && "string" == s)
                for (
                  e = (r = e).trim ? r.trim() : r.replace(/^\s+|\s+$/g, "");
                  e.length % 4 != 0;
              ...
              if (
                (g._useTypedArrays
                  ? (i = g._augment(new Uint8Array(o)))
                  : (((i = this).length = o), (i._isBuffer = !0)),
                g._useTypedArrays && "number" == typeof e.byteLength)
              )
                i._set(e);
              else if (
                S((a = e)) ||
              ...
              else if ("number" == s && !g._useTypedArrays && !n)
                for (u = 0; u < o; u++) i[u] = 0;
              return i;
            }
            function y(e, t, n, r) {
              return (g._charsWritten = T(
                (function (e) {
            ...
            function E(e, t, n, r, o) {
              o ||
                ...
                D(n + 1 < e.length, "Trying to write beyond buffer length"),
                Y(t, 32767, -32768)),
                e.length <= n || v(e, 0 <= t ? t : 65535 + t + 1, n, r, o);
            }
            function I(e, t, n, r, o) {
              o ||
                ...
                D(null != n, "missing offset"),
                D(n + 3 < e.length, "Trying to write beyond buffer length"),
                Y(t, 2147483647, -2147483648)),
                e.length <= n || _(e, 0 <= t ? t : 4294967295 + t + 1, n, r, o);
            }
            function A(e, t, n, r, o) {
              o ||
                ...
                e.length <= n || f.write(e, t, n, r, 23, 4);
            }
            function B(e, t, n, r, o) {
              o ||
                ...
                e.length <= n || f.write(e, t, n, r, 52, 8);
            }
            (H.Buffer = g),
              (H.SlowBuffer = g),
              (H.INSPECT_MAX_BYTES = 50),
              (g.poolSize = 8192),
              (g._useTypedArrays = (function () {
                try {
                ...
                switch (e) {
                  ...
                  case "utf-8":
                    r = (function (e, t, n) {
                      ...
                      for (var i = t; i < n; i++)
                        e[i] <= 127
                          ? ((r += M(o) + String.fromCharCode(e[i])), (o = ""))
                          : (o += "%" + e[i].toString(16));
                      return r + M(o);
                    })(a, t, n);
                    break;
              ...
              (g.prototype.slice = function (e, t) {
                var n = this.length;
                if (((e = U(e, n, 0)), (t = U(t, n, n)), g._useTypedArrays))
                  return g._augment(this.subarray(e, t));
            ...
            g._augment = function (e) {
              return (
                ...
                (e.toLocaleString = L.toString),
                (e.toJSON = L.toJSON),
                (e.copy = L.copy),
                (e.slice = L.slice),
                (e.readUInt8 = L.readUInt8),
                (e.readUInt16LE = L.readUInt16LE),
                (e.readUInt16BE = L.readUInt16BE),
                (e.readUInt32LE = L.readUInt32LE),
                (e.readUInt32BE = L.readUInt32BE),
                (e.readInt8 = L.readInt8),
                (e.readInt16LE = L.readInt16LE),
                (e.readInt16BE = L.readInt16BE),
                (e.readInt32LE = L.readInt32LE),
                (e.readInt32BE = L.readInt32BE),
                (e.readFloatLE = L.readFloatLE),
                (e.readFloatBE = L.readFloatBE),
                (e.readDoubleLE = L.readDoubleLE),
                (e.readDoubleBE = L.readDoubleBE),
                (e.writeUInt8 = L.writeUInt8),
                (e.writeUInt16LE = L.writeUInt16LE),
                (e.writeUInt16BE = L.writeUInt16BE),
                (e.writeUInt32LE = L.writeUInt32LE),
                (e.writeUInt32BE = L.writeUInt32BE),
                (e.writeInt8 = L.writeInt8),
                (e.writeInt16LE = L.writeInt16LE),
                (e.writeInt16BE = L.writeInt16BE),
                (e.writeInt32LE = L.writeInt32LE),
                (e.writeInt32BE = L.writeInt32BE),
                (e.writeFloatLE = L.writeFloatLE),
                (e.writeFloatBE = L.writeFloatBE),
                (e.writeDoubleLE = L.writeDoubleLE),
                (e.writeDoubleBE = L.writeDoubleBE),
                (e.fill = L.fill),
                (e.inspect = L.inspect),
                (e.toArrayBuffer = L.toArrayBuffer),
                e
              );
            };
          }.call(
              ...
              hash: function (e, t, n, r) {
                return (
                  ...
                  (function (e, t, n) {
                    for (
                      var r = new u(t),
                        o = n ? r.writeInt32BE : r.writeInt32LE,
                        i = 0;
                      i < e.length;
                      i++
                    )
          ...
          (function (e, t, a, n, r, o, i, u, s) {
            ...
            function g(e, r) {
              var o = d[(e = e || "sha1")],
                i = [];
              return (
                o || y("algorithm:", e, "is not yet supported"),
                {
                  update: function (e) {
                    return (
                      a.isBuffer(e) || (e = new a(e)), i.push(e), e.length, this
                    );
                  },
                  digest: function (e) {
                    var t = a.concat(i),
                      n = r
                        ? (function (e, t, n) {
                            a.isBuffer(t) || (t = new a(t)),
                              ...
                              t.length > h
                                ? (t = e(t))
                                : t.length < h && (t = a.concat([t, p], h));
                            for (
                              var r = new a(h), o = new a(h), i = 0;
                              i < h;
                              i++
                            )
            ...
            p.fill(0),
              (b.createHash = function (e) {
                return g(e);
              }),
              (b.createHmac = g),
              (b.randomBytes = function (e, t) {
                if (!t || !t.call) return new a(c(e));
                try {
                  t.call(this, void 0, new a(c(e)));
                } catch (e) {
                  t(e);
                }
              }),
          ...
          (function (e, t, n, r, o, i, u, a, s) {
            ...
            function l(e, t) {
              ...
              for (
                ...
                (n = d(n, r, o, i, e[u + 4], 7, -176418897)),
                  (i = d(i, n, r, o, e[u + 5], 12, 1200080426)),
                  (o = d(o, i, n, r, e[u + 6], 17, -1473231341)),
                  (r = d(r, o, i, n, e[u + 7], 22, -45705983)),
                  (n = d(n, r, o, i, e[u + 8], 7, 1770035416)),
                  (i = d(i, n, r, o, e[u + 9], 12, -1958414417)),
                  (o = d(o, i, n, r, e[u + 10], 17, -42063)),
                  (r = d(r, o, i, n, e[u + 11], 22, -1990404162)),
                  (n = d(n, r, o, i, e[u + 12], 7, 1804603682)),
                  (i = d(i, n, r, o, e[u + 13], 12, -40341101)),
                  (o = d(o, i, n, r, e[u + 14], 17, -1502002290)),
                  (n = h(
                    n,
                    (r = d(r, o, i, n, e[u + 15], 22, 1236535329)),
                    o,
                    i,
                    e[u + 1],
                    5,
                  ...
                  (i = h(i, n, r, o, e[u + 6], 9, -1069501632)),
                  (o = h(o, i, n, r, e[u + 11], 14, 643717713)),
                  (r = h(r, o, i, n, e[u + 0], 20, -373897302)),
                  (n = h(n, r, o, i, e[u + 5], 5, -701558691)),
                  (i = h(i, n, r, o, e[u + 10], 9, 38016083)),
                  (o = h(o, i, n, r, e[u + 15], 14, -660478335)),
                  (r = h(r, o, i, n, e[u + 4], 20, -405537848)),
                  (n = h(n, r, o, i, e[u + 9], 5, 568446438)),
                  (i = h(i, n, r, o, e[u + 14], 9, -1019803690)),
                  (o = h(o, i, n, r, e[u + 3], 14, -187363961)),
                  (r = h(r, o, i, n, e[u + 8], 20, 1163531501)),
                  (n = h(n, r, o, i, e[u + 13], 5, -1444681467)),
                  (i = h(i, n, r, o, e[u + 2], 9, -51403784)),
                  (o = h(o, i, n, r, e[u + 7], 14, 1735328473)),
                  (n = p(
                    n,
                    (r = h(r, o, i, n, e[u + 12], 20, -1926607734)),
                    o,
                    i,
                    e[u + 5],
                    4,
                  ...
                  (i = p(i, n, r, o, e[u + 8], 11, -2022574463)),
                  (o = p(o, i, n, r, e[u + 11], 16, 1839030562)),
                  (r = p(r, o, i, n, e[u + 14], 23, -35309556)),
                  (n = p(n, r, o, i, e[u + 1], 4, -1530992060)),
                  (i = p(i, n, r, o, e[u + 4], 11, 1272893353)),
                  (o = p(o, i, n, r, e[u + 7], 16, -155497632)),
                  (r = p(r, o, i, n, e[u + 10], 23, -1094730640)),
                  (n = p(n, r, o, i, e[u + 13], 4, 681279174)),
                  (i = p(i, n, r, o, e[u + 0], 11, -358537222)),
                  (o = p(o, i, n, r, e[u + 3], 16, -722521979)),
                  (r = p(r, o, i, n, e[u + 6], 23, 76029189)),
                  (n = p(n, r, o, i, e[u + 9], 4, -640364487)),
                  (i = p(i, n, r, o, e[u + 12], 11, -421815835)),
                  (o = p(o, i, n, r, e[u + 15], 16, 530742520)),
                  (n = g(
                    n,
                    (r = p(r, o, i, n, e[u + 2], 23, -995338651)),
                    o,
                    i,
                    e[u + 0],
                    6,
            ...
            function c(e, t, n, r, o, i) {
              return y(
                ((u = y(y(t, e), y(r, i))) << (a = o)) | (u >>> (32 - a)),
                n
              );
              var u, a;
            }
            function d(e, t, n, r, o, i, u) {
              return c((t & n) | (~t & r), e, t, o, i, u);
            }
            function h(e, t, n, r, o, i, u) {
              return c((t & r) | (n & ~r), e, t, o, i, u);
            }
            function p(e, t, n, r, o, i, u) {
              return c(t ^ n ^ r, e, t, o, i, u);
            }
            function g(e, t, n, r, o, i, u) {
              return c(n ^ (t | ~r), e, t, o, i, u);
            }
            function y(e, t) {
                  ...
                  t = Math.abs(t),
                    isNaN(t) || t === 1 / 0
                      ...
                      : ((u = Math.floor(Math.log(t) / Math.LN2)),
                        ...
                        2 <=
                          (t += 1 <= u + c ? d / s : d * Math.pow(2, 1 - c)) *
                            s && (u++, (s /= 2)),
                        l <= u + c
                          ? ((a = 0), (u = l))
                          : 1 <= u + c
                          ? ((a = (t * s - 1) * Math.pow(2, o)), (u += c))
